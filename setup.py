...
_32_BIT_INTERPRETER = struct.calcsize("P") == 4 # From https://github.com/pypa/packaging/pull/711


jq_extension = Extension(
    "jq",
    sources=[_path_in_dir(f"jq{ext}")],
    define_macros=[("MS_WIN64" , "1")] if os.name == "nt" and _32_BIT_INTERPRETER else None, # https://github.com/cython/cython/issues/2670
